    ...
    <div className="grid lg:grid-cols-4 xl:grid-cols-6 min-h-screen">
      ...
      <main className="lg:col-span-3 xl:col-span-5 bg-gray-100 p-8 h-[100vh] overflow-y-scroll">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 mt-10 gap-8">
          {/* Card 1 */}
          <div className="bg-primary-100 p-8 rounded-xl text-black flex flex-col gap-6">
            <RiLineChartLine className="text-5xl" />
            <h4 className="text-2xl">Earnings</h4>
            <span className="text-5xl text-black">&euro; 8,350</span>
          ...
          <div className="p-4 bg-white rounded-xl flex flex-col justify-between gap-4 drop-shadow-2xl">
            <div className="flex items-center gap-4 bg-primary-100/10 rounded-xl p-4">
              ...
              <div>
                ...
                <p className="text-black">In top 30%</p>
              </div>
            </div>
            <div className="bg-primary-100/10 rounded-xl p-4">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-black">8 this month</p>
                </div>
              </div>
              <div className="flex items-center gap-2 text-gray-500 text-sm">
                <span className="text-black py-1 px-4 rounded-full">
                  Mobile app
                </span>
                <span className="text-black py-1 px-4 rounded-full">
                  Branding
            ...
            <div className="bg-white p-8 rounded-xl shadow-2xl">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-black">1 day remaining</p>
                </div>
              </div>
              <div className="flex items-center gap-4 mb-4">
                <img
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 mt-10 gap-8">
          <div>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-4 items-center gap-4 mb-4">
                <div className="col-span-2 flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-black">JQ Holdings</p>
                  </div>
                </div>
                <div>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-4 items-center gap-4 mb-4">
                <div className="col-span-2 flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-black">Inchor Techs</p>
                  </div>
                </div>
                <div>
            ...
            <div className="bg-primary-900 text-gray-300 p-8 rounded-xl shadow-2xl flex items-center justify-between flex-wrap xl:flex-nowrap gap-8">
              <div>
                <RiHashtag className="text-4xl text-black -rotate-12" />
              </div>
              <div>
                <h5 className="font-bold text-black">Engage with clients</h5>
                <h5 className="text-black">Join slack channel</h5>
              </div>
          ...
          <div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-2xl mb-8 flex flex-col gap-8">
              <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-black">Updated 10m ago</p>
                  </div>
                </div>
                <div>
                  <span className="bg-primary-100 py-2 px-4 rounded-full text-black">
                    Design
                  </span>
                </div>
              </div>
              ...
              <div className="bg-primary-100/10 flex flex-col md:flex-row items-center justify-between gap-4 py-8 px-4 rounded-lg">
                <div>
                  <sup className="text-sm text-black">&euro;</sup>{" "}
                  <span className="text-2xl font-bold mr-2">8,700</span>
                  <span className="text-sm text-black">/ month</span>
                </div>
                <div>
                  <span className="border border-primary-100 text-black py-2 px-4 rounded-full">
                    Full time
                  </span>
                </div>
              </div>
